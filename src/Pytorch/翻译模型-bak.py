...
datasets = load_dataset("opus100", "en-zh")


# # 将训练集划分为1000个部分，并选择其中一个作为新的训练集
# small_train_dataset = datasets["train"].shard(num_shards=1000, index=0)
# # 使用新的较小的训练集替换原来的训练集
# datasets["train"] = small_train_dataset
...
args = Seq2SeqTrainingArguments(
    "test-translation",  # 输出目录，模型和训练日志将保存到这里
